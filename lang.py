...
FA = {
    ...
    "watch_usage": "روش استفاده: `/watch 0x...`\nآدرس ولت اتریوم را وارد کن تا تراکنش‌هایش رصد بشه.\n\nمثال: `/watch 0x742d35Cc6634C0532925a3b844Bc9e7595f2bD18`",
...
EN = {
    ...
    "watch_usage": "Usage: `/watch 0x...`\nEnter an Ethereum wallet address to monitor its transactions.\n\nExample: `/watch 0x742d35Cc6634C0532925a3b844Bc9e7595f2bD18`",
