...
EN = {
    ...
    "watch_usage": "Usage: `/watch 0x... [network]`\nMonitor a wallet address across one or all networks.\nIf no network specified, adds to all 22 chains.\n\nExample: `/watch 0x742d35Cc6634C0532925a3b844Bc9e7595f2bD18 eth`\nExample: `/watch 0x... all`\n\nNetworks: eth, bsc, polygon, arb, base, op, avax, ...",
